...
func TestDetectDefaultBranch(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			setup: func() *MockGitExecutor {
				mock := NewMockGitExecutor()
				mock.SetErrorResponse("symbolic-ref refs/remotes/origin/HEAD", "no such ref")
		...
		},
		{
			...
			setup: func() *MockGitExecutor {
				mock := NewMockGitExecutor()
				mock.SetErrorResponse("symbolic-ref refs/remotes/origin/HEAD", "no such ref")
				mock.SetErrorResponse("branch --show-current", "not a git repository")
		...
		},
		{
			...
			setup: func() *MockGitExecutor {
				...
				mock.SetErrorResponse("symbolic-ref refs/remotes/origin/HEAD", "no such ref")
				mock.SetErrorResponse("branch --show-current", "not a git repository")
				mock.SetErrorResponse("ls-remote --symref origin HEAD", "network error")
		...
		},
		{
			...
			setup: func() *MockGitExecutor {
				...
				mock.SetErrorResponse("branch --show-current", "not a git repository")
				mock.SetErrorResponse("ls-remote --symref origin HEAD", "network error")
				mock.SetErrorResponse("remote show origin", "network error")
		...
		},
		{
			...
			setup: func() *MockGitExecutor {
				...
				mock.SetErrorResponse("ls-remote --symref origin HEAD", "network error")
				mock.SetErrorResponse("remote show origin", "network error")
				mock.SetErrorResponse("branch -r", "no remote branches")
				return mock
			},
			expected: "main",
		},
...
func TestBranchValidationIntegration(t *testing.T) {
	...
	tests := []struct {
		name        string
		setupMock   func() *MockGitExecutor
		expectEmpty bool
		description string
	}{
		{
