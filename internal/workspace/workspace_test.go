...
func TestInitialize_SucceedsOnEmptyDirectory(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_FailsOnNonEmptyDirectory(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_CleansUpOnGitFailure(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_CleansUpOnGitFileFailure(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_NoCleanupOnExistingDirectory(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_DetectsExistingGitDirectory(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_DetectsExistingGitFile(t *testing.T) {
	tempDir := t.TempDir()
...
func TestInitialize_FailsInsideGitRepository(t *testing.T) {
	tempDir := t.TempDir()
