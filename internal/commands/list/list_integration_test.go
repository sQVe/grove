...
func TestListCommandWithRealGitRepo(t *testing.T) {
	...
	tempDir := helper.CreateTempDir("grove-list-integration")
...
func TestListCommandWithMultipleWorktrees(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-multi")
...
func TestListCommandWithComplexBranchNames(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-complex")
...
func TestListCommandWithRemoteTracking(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-remote")
...
func TestListCommandCurrentWorktreeDetection(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-current")
...
func TestListCommandValidationErrors(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-validation")
...
func TestListCommandCornerCases(t *testing.T) {
	helper := testutils.NewIntegrationTestHelper(t).WithCleanFilesystem()
	tempDir := helper.CreateTempDir("grove-list-corner")
