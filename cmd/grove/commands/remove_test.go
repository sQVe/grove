...
func TestRunRemove_NotInWorkspace(t *testing.T) {
	...
	err := runRemove([]string{"some-branch"}, false, false, false, false)
...
func TestRunRemove_WorktreeNotFound(t *testing.T) {
	...
	err := runRemove([]string{"nonexistent"}, false, false, false, false)
	if err == nil {
...
func TestRunRemove_CurrentWorktree(t *testing.T) {
	...
	err := runRemove([]string{"main"}, false, false, false, false)
	if err == nil {
...
func TestRunRemove_DirtyWorktree(t *testing.T) {
	...
	err := runRemove([]string{"feature"}, false, false, false, false)
	if err == nil {
...
func TestRunRemove_ForceDirty(t *testing.T) {
	...
	err := runRemove([]string{"feature"}, true, false, false, false)
	if err != nil {
...
func TestRunRemove_WithBranchFlag(t *testing.T) {
	...
	err := runRemove([]string{"feature"}, false, true, false, false)
	if err != nil {
...
func TestRunRemove_MultipleWorktrees(t *testing.T) {
	...
	err := runRemove([]string{"feature", "bugfix"}, false, false, false, false)
	if err != nil {
		t.Fatalf("runRemove failed: %v", err)
	}
...
func TestRunRemove_MultipleWithForce(t *testing.T) {
	...
	err := runRemove([]string{"feature", "bugfix"}, true, false, false, false)
	if err != nil {
		t.Fatalf("runRemove with force failed: %v", err)
	}
...
func TestRunRemove_MultipleWithOneCurrent(t *testing.T) {
	...
	err := runRemove([]string{"feature", "main"}, false, false, false, false)
	if err == nil {
...
func TestRunRemove_MultipleWithDeleteBranch(t *testing.T) {
	...
	// Remove with --branch flag
	err := runRemove([]string{"feature", "bugfix"}, false, true, false, false)
	if err != nil {
		t.Fatalf("runRemove failed: %v", err)
	}
...
func TestRunRemove_DuplicateArgs(t *testing.T) {
	...
	err := runRemove([]string{"feature", "feature"}, false, false, false, false)
	if err != nil {
...
func TestRunRemove_ErrorShowsWorktreeLabel(t *testing.T) {
	...
	_ = runRemove([]string{"feat-auth"}, false, false, false, false)
